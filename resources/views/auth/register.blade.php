...
<div class="container">
	...
	<div class="col-md-1"></div>
		...
		@endif
            <div class="card">
                <div class="card-header" style="color:#FF0000; font-weight:bold; font-size:16px;">{{ __('Register') }}</div>
                ...
                <div class="card-body" style="padding-top:10px;">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4" align="right" style="padding-right:30px;">
