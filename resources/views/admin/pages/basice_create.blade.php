...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Basic Manage</h4>
        </div>
      </div>
      <div class="row staff-grid-row">
				  ...
				  <div class="modal-dialog">
					<div class="modal-content">
					  ...
					  <div class="modal-header">
						<h5 class="modal-title">Add Basic Information</h5>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					  </div>
					  <!-- Modal body -->
					  <div class="modal-body">
					   <form method="post" enctype="multipart/form-data" action="{{ route('admin.basic.store') }}"/>
	  					@csrf
						...
						<div style="padding-bottom:15px;">
						  <label for="usr">Logo Upload :</label>
		...
		<div class="col-md-12 col-sm-6 col-xs-6 col-lg-12">
           <table class="table table-bordered">
			...
			<tbody>
			@foreach($basic_manages as $basic_manages)
			  <tr>
				<td>{{$basic_manages->title}}</td>

				<td>
				   <img style="height:30px;" src="{{asset('images/slider/' . $basic_manages->logo)}}">
				</td>

				<td style="text-align:center;">
				<a href="#EditModal" data-toggle="modal" data-target="#EditModal{{ $basic_manages->id }}"><i class="fa fa-pencil" aria-hidden="true"></i> </a>

				 <!-- Edit Modal Start -->
				<div class="modal" id="EditModal{{ $basic_manages->id }}">
				  <div class="modal-dialog">
					<div class="modal-content">
					  <!-- Modal Header -->
					  <div class="modal-header">
						<h5 class="modal-title" style="text-align:left;">Edit Basics</h5>
						<button type="button" class="close" data-dismiss="modal">&times;</button>
					  </div>
					  <!-- Modal body -->
					  <div class="modal-body">
					   <form method="post" enctype="multipart/form-data" action="{{ route('admin.basic.update', $basic_manages->id) }}"/>
	  					@csrf
        				<div style="padding-bottom:10px; text-align:left;">
						  <label for="usr">Title :</label>
						  <input type="text" class="form-control" id="name" value="{{ $basic_manages->title }}" name="name">
					    </div>
					
						<div style="padding-bottom:10px; text-align:left;">
						  <label for="usr">Title :</label>
						  <input type="text" class="form-control" id="phone" value="{{ $basic_manages->phone }}" name="phone">
						</div>
			...
			<!-- <a href="#deleteModal" data-toggle="modal" data-target="#myModal{{ $basic_manages->id }}"><i class="fa fa-trash-o" aria-hidden="true"></i></a>-->
				<!-- Delete Modal Start -->
				<!--<div class="modal" id="myModal{{ $basic_manages->id }}">
				  <div class="modal-dialog">
					<div class="modal-content">
					  ...
					  <div class="modal-body">
					    <form method="post" enctype="multipart/form-data" action="{{ route('admin.slider.delete', $basic_manages->id) }}"/>
	  						@csrf
