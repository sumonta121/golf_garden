...
<div class="main-wrapper">
  ...
  <div class="page-wrapper">
    <div class="content container-fluid">
      <div class="row">
        <div class="col-xs-4">
          <h4 class="page-title">Sub Category Edit Manage</h4>
        </div>
      </div>
		...
		<div class="col-md-12 col-sm-6 col-xs-6 col-lg-12">
          <div class="form-group">
			  ...
			  <select class="form-control" id="category_id" name="category_id">
				...
				<option value="{{$categories->id}}"  @php if($sub_category->category_id == $categories->id){ echo "selected"; } @endphp >{{$categories->name}}</option>
				@endforeach 
			  </select>
			</div>
        </div>
