...
.product-grid .social{width:100%;padding:0;margin:0;list-style:none;opacity:0;transform:translateY(-50%) translateX(-50%);position:absolute;top:60%;left:50%;z-index:1;transition:all .3s ease 0s}
...
<?php
	...
	<div style="">
			...
			<div class="col-md-1" style="border-top:1px #9a9a9a solid; padding-bottom:10px;"></div>
				<div class="col-md-10" align="center" style="font-size:16px; padding-top:20px;">Searching Results : {{ $header_search_value }}</div>
			...
			<div class="row" align="center" style="margin-left:0px; border-left:1px #ecc766 solid; min-height:700px; padding-top:20px;">
				  	<div class="container">
						<div class="row">
						 ...
						 @foreach($products as $productserchvalu)
						<div class="col-md-3 col-sm-6" style="padding-top:10px;">
								<div class="product-grid" style="padding-bottom:0px;">
									<div class="product-image">
										<a href="{{ route('Product_details', $productserchvalu->slug) }}">
											<img class="pic-1" src="{{asset('images/products/' . $productserchvalu->image)}}">
											<img class="pic-2" src="{{asset('images/products/' . $productserchvalu->image2)}}">
									...
									<div style="color:#000000; font-weight:bold; font-size:14px; padding:5px;">{{ $productserchvalu->title }}</div>
									<div style="color:#FF0000; font-weight:bold; font-size:14px; padding:5px;">
            						    BDT-{{ $productserchvalu->price }} <del class="del">BDT-{{ $productserchvalu->offer_price }} </del>
									 </div>
